 ...
 * @author Huy-Nguyen
 */
public class TienNuoc extends javax.swing.JFrame {

    /**
     * Creates new form TienNuoc
     */
    public TienNuoc() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TienNuoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
